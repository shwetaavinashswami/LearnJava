...
public class BinaryOperatorExamples {
    public static void main(String[] args) {
        ...
        f = 0;
        if ((e++ <= f) | (++e < f)) {
            System.out.println("Evaluation [(e++ <= f) | (++e < f)] met"); // will print
        }
        ...
        f = 0;
        if ((e++ < f) || (++e <= f)) {
            System.out.println("Evaluation [(e++ <= f) || (++e < f)] met"); // will not print
        }
        ...
        b = 10;
        if ((++a > b) & (++a >= b)) {
            System.out.println("Evaluation [(++a > b) & (++a >= b)] met"); //Dont print
        }
        ...
        b = 0;
        if ((++a > b) && (++a >= b)) {
            System.out.println("Evaluation [(++a > b) && (++a >= b)] met"); //print
        }
