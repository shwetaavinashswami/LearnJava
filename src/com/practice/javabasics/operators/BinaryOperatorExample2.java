...
public class BinaryOperatorExample2 {
    public static void main(String[] args) {
        ...
        if (a == c) {
            System.out.println("a and c primitive values are equal");  //print
        }
        if (a != b) {
            System.out.println("a and b are not equal because primitive" +
                    " data values are not equal");// print
        }
        ...
        String s3 = s2.intern();
        if (s1 == s3) {
            System.out.println("Strings are equal if they are interned or are String literals"); //print
        }
        if (s1 != s2) {
            System.out.println("Otherwise String objects are not equal");//print
        }
        ...
        if (o1 == o2) {
            System.out.println("Objects are equal if they reference same object");//print
        }
        if (o1 != o3) {
            System.out.println("Otherwise  objects are not equal");//print
        }
        ...
        System.out.println("result of bitwise XOR (0b0000_1111 ^ 0b0000_1111) = "
                + String.format("%8s", Integer.toBinaryString(
                0b0000_1111 ^ 0b0000_1111)).replace(' ', '0'));//00000000
        ...
        b1 *= 2;
        System.out.println("b1 (after b1 *= 2 ) = " + b1);//4
        b2 /= 2;
        System.out.println("b2 (after b2 /= 2) = " + b2);//1
        b3 %= 2;
        System.out.println("b3 (after b3 %= 2) = " + b3);//1
        ...
        System.out.println("b1 (after b1 += 2) = " + b1);//4
        b2 -= 2;
        System.out.println("b2 (after b2 -= 2) = " + b2);//0
        ...
        b1 = 0b0000;
        b1 &= 0b1111;
        System.out.println("b1 (after b1 &= 0b1111 ) = " + b1);//0000
        b1 |= 0b1111;
