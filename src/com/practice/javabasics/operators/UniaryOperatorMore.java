...
public class UniaryOperatorMore {
    public static void main(String[] args) {
        ...
        int test = 10;
        int test2= ~test;
        System.out.println("test 1 is: " + test);
        System.out.println("test 2 is: " + test2);

        System.out.println("test 1 in binary format is: " + Integer.toBinaryString(test));
        System.out.println("test 2 in binary format is: " + Integer.toBinaryString(test2));
    }
}
