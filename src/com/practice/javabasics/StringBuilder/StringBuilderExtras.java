package com.practice.javabasics.StringBuilder;
...
public class StringBuilderExtras {
    public static void main(String[] args) {
        ...
        // What do you think trimToSize does? ---> reduces capacity to length
        builder.trimToSize();
        ...
        System.out.println("Now the builder is: " + builder);
